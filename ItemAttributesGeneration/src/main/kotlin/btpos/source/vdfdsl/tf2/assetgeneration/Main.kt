...
import btpos.source.vdfdsl.tf2.assetgeneration.ItemAttributesGeneration.BuildConfig
...
import btpos.source.vdfdsl.tf2.assetgeneration.representations.groupings.PenaltyBonus
import btpos.source.vdfdsl.tf2.assetgeneration.representations.groupings.Vis
...
fun generateItemAttributes() {
	...
	val TARGET_PACKAGE = BuildConfig.ATTRIBUTES_TARGET_PACKAGE
