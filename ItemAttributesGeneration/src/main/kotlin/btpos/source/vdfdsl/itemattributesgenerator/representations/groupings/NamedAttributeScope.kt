...
import btpos.source.vdfdsl.itemattributesgenerator.overrideScopeName
import btpos.source.vdfdsl.itemattributesgenerator.representations.FakeCodec
...
import btpos.source.vdfdsl.itemattributesgenerator.sanitize
...
open class NamedAttributeScope(
	...
	override fun generateTopLevelMembers(): List<String> {
		...
		return listOf(
			buildComment(innateDescription) + "\n" + """object $clsname {
