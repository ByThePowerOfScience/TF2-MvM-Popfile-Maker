 ...
 */
interface StickybombLauncherAttributes : btpos.source.vdfdsl.tf2.itemattributes.BaseGunAttributes, btpos.source.vdfdsl.tf2.itemattributes.IBlockScoped {
	...
	var stickiesDetonateStickies: Boolean?
		get() = attrs.getTyped("stickies detonate stickies", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("stickies detonate stickies", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	 ...
	 * 
	 */
	val maxStickies get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.BonusPenalty<Int, Int>("max pipebombs increased", "max pipebombs decreased")
}
