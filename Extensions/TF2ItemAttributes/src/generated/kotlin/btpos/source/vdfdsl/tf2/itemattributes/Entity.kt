...
interface EntityAttributes : btpos.source.vdfdsl.tf2.itemattributes.IBlockScoped {
	...
	var cannotBeBackstabbed: Boolean?
		get() = attrs.getTyped("cannot be backstabbed", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("cannot be backstabbed", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	
	/**
	 * 
	 */
	val buildings get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.BuildingsAttributes
	 ...
	 * 
	 */
	val healthFromPacks get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.BonusPenalty<Float, Float>("health from packs increased", "health from packs decreased")
	...
	var parachuteAttribute: Boolean?
		get() = attrs.getTyped("parachute attribute", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("parachute attribute", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
...
object BuildingsAttributes {
	...
	val allBuildings get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.AllBuildingsAttributes
	
	
	val sentry get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.SentryAttributes
	
	
	val dispenser get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.DispenserAttributes
	
	
	val teleporter get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.TeleporterAttributes
}
...
object TeleporterAttributes {
	...
	var bidirectionalTeleport: Boolean?
		get() = attrs.getTyped("bidirectional teleport", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("bidirectional teleport", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
}
