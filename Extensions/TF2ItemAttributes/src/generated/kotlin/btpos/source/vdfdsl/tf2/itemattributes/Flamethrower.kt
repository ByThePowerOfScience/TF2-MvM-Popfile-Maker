 ...
 */
interface FlamethrowerAttributes : btpos.source.vdfdsl.tf2.itemattributes.WeaponBaseAttributes, btpos.source.vdfdsl.tf2.itemattributes.IBlockScoped {
	...
	var airblastDisabled: Boolean?
		get() = attrs.getTyped("airblast disabled", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("airblast disabled", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	...
	var chargedAirblast: Boolean?
		get() = attrs.getTyped("charged airblast", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("charged airblast", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	
	/**
	 * 
	 */
	val airblastCost get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.AirblastCostAttributes
	...
	var flamethrowerBackCrit: Boolean?
		get() = attrs.getTyped("mod flamethrower back crit", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("mod flamethrower back crit", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	 ...
	 * 
	 */
	val flameAmmopersec get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.BonusPenalty<Float, Float>("flame ammopersec decreased", "flame ammopersec increased")
	...
	var spellHalloweenGreenFlames: Boolean?
		get() = attrs.getTyped("SPELL: Halloween green flames", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("SPELL: Halloween green flames", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	 ...
	 * Checked on owner.
	 */
	val flameSize get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.BonusPenalty<Float, Float>("flame size bonus", "flame size penalty")
	 ...
	 * Checked on owner.
	 */
	val flameLife get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.BonusPenalty<Float, Float>("flame life bonus", "flame life penalty")
	...
	var airblastDestroyProjectile: Boolean?
		get() = attrs.getTyped("airblast_destroy_projectile", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("airblast_destroy_projectile", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	...
	var airblastPushbackDisabled: Boolean?
		get() = attrs.getTyped("airblast_pushback_disabled", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("airblast_pushback_disabled", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	
	/**
	 * 
	 */
	val flame get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.FlameAttributes
}
...
object FlameAttributes {
	...
	var flameReflectOnCollision: Boolean?
		get() = attrs.getTyped("flame_reflect_on_collision", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("flame_reflect_on_collision", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
