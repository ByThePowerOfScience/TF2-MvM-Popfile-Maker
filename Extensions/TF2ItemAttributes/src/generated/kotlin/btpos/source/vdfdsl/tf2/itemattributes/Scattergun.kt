 ...
 */
interface ScattergunAttributes : btpos.source.vdfdsl.tf2.itemattributes.ShotgunAttributes, btpos.source.vdfdsl.tf2.itemattributes.IBlockScoped {
	...
	var scattergunHasKnockback: Boolean?
		get() = attrs.getTyped("scattergun has knockback", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("scattergun has knockback", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
