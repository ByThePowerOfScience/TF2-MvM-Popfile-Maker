 ...
 */
interface SniperRifleAttributes : btpos.source.vdfdsl.tf2.itemattributes.BaseGunAttributes, btpos.source.vdfdsl.tf2.itemattributes.IBlockScoped {
	...
	var cannotHeadshot: Boolean?
		get() = attrs.getTyped("sniper no headshots", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.NumberSelectorCodec(1))
		set(value) = attrs.setNullable("sniper no headshots", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.NumberSelectorCodec(1))
	 ...
	 * 
	 */
	val srifleChargeRate get() = _root_ide_package_.btpos.source.vdfdsl.tf2.itemattributes.BonusPenalty<Float, Float>("sniper charge per sec", "SRifle Charge rate decreased")
	...
	var canOnlyFireWhenZoomed: Boolean?
		get() = attrs.getTyped("sniper only fire zoomed", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("sniper only fire zoomed", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	...
	var penetratesWhenFullyCharged: Boolean?
		get() = attrs.getTyped("sniper penetrate players when charged", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("sniper penetrate players when charged", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	...
	var cannotHeadshotWithoutFullCharge: Boolean?
		get() = attrs.getTyped("sniper no headshot without full charge", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("sniper no headshot without full charge", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
	...
	var canHeadshotUnscoped: Boolean?
		get() = attrs.getTyped("sniper crit no scope", _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
		set(value) = attrs.setNullable("sniper crit no scope", value, _root_ide_package_.btpos.source.vdfdsl.serialization.codecs.BinaryIntCodec)
