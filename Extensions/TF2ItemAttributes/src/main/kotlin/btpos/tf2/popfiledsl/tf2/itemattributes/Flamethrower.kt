 ...
 * 
 */
abstract class FlamethrowerAttributes : WeaponBaseAttributes() {
	companion object : FlamethrowerAttributes() {
		operator fun invoke(scope: FlamethrowerAttributes.Companion.() -> Unit) {
			this.apply(scope)
		}
	}
	 ...
	 * 	
	 */
	val flameAmmopersecIncreased = BonusPenalty<Float, Float>("flame ammopersec decreased", "flame ammopersec increased")
	 ...
	 * 	
	 */
	val flameSizePenalty = BonusPenalty<Float, Float>("flame size bonus", "flame size penalty")
	 ...
	 * 	
	 */
	val flameLifePenalty = BonusPenalty<Float, Float>("flame life bonus", "flame life penalty")
