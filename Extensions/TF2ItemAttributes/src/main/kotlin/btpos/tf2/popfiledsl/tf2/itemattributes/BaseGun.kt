 ...
 * 
 */
abstract class BaseGunAttributes : WeaponBaseAttributes() {
	companion object : BaseGunAttributes() {
		operator fun invoke(scope: BaseGunAttributes.Companion.() -> Unit) {
			this.apply(scope)
		}
	}
	 ...
	 * 	
	 */
	val ProjectileRangeDecreased = BonusPenalty<Float, Float>("Projectile range increased", "Projectile range decreased")
	 ...
	 * 	
	 */
	val spreadPenalty = BonusPenalty<Float, Float>("weapon spread bonus", "spread penalty")
