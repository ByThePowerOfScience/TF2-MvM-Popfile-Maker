...
public class VDFGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "STRING", "LITERAL", "NUMBER", "COMMENT_START", "STRING_ELEMENT", 
			"NL", "WORDCHAR", "OPENBRACE", "CLOSEBRACE"
		};
	}
	...
	public VDFGrammarLexer(CharStream input) {
		super(input);
