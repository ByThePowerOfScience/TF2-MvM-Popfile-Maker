...
interface FlagAttributes : IBlockScoped, BaseMeleeAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = FlagAttributes.buffItems
	
	override val cloak: CloakAttributes get() = FlagAttributes.cloak
	
	override val disguise: DisguiseAttributes get() = FlagAttributes.disguise
	
	override val hud: HudAttributes get() = FlagAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = FlagAttributes.spyOnly
	...
	object Inherited : FlagAttributes 
}