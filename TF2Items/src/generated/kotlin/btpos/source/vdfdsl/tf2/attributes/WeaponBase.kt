...
interface WeaponBaseAttributes : BaseCombatWeaponAttributes, IBlockScoped {
	 ...
	 */
	context(attrs: IKeyValueMap)
	var weaponStattrakModuleScale: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var effectBarRechargeRateIncreased: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var uberchargeRateBonusForHealer: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var increasedJumpHeightFromWeapon: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var dmgPenaltyVsNonburning: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var energyBuffDmgTakenMultiplier: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var dmgTakenFromFireReducedOnActive: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var damageBonusVsBurning: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var dmgFromMeleeIncreased: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var dmgFromRangedReduced: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var blastDmgToSelfIncreased: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var multHealthFromhealersPenaltyActive: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var overhealFillRateReduced: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	override var reducedHealingFromMedics: Float?
	 ...
	 * Afterburn damage.
	 */
	val weaponBurnDmgReduced get() = BonusPenalty<Float, Float>("weapon burn dmg increased", "weapon burn dmg reduced")
	 ...
	 * Afterburn duration.
	 */
	val weaponBurnTimeReduced get() = BonusPenalty<Float, Float>("weapon burn time increased", "weapon burn time reduced")
	 ...
	 */
	context(attrs: IKeyValueMap)
	var damageBonusBulletVsSentryTarget: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var moveSpeedBonusResourceLevel: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var multPlayerMovespeedActive: Float?
	 ...
	 */
	context(attrs: IKeyValueMap)
	var damagePenaltyOnBodyshot: Float?
	 ...
	 * 
	 */
	val healingReceived get() = BonusPenalty<Float, Float>("healing received bonus", "healing received penalty")
	 ...
	 */
	val selfDmgPushForce get() = BonusPenalty<Float, Float>("self dmg push force increased", "self dmg push force decreased")
	 ...
	 */
	val damageForce get() = BonusPenalty_PenaltyNested<Float, VisHidden<Float, Float>>("damage force reduction", VisHidden<Float, Float>("damage force increase", "damage force increase hidden"))
