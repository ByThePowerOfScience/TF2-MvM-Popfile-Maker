...
interface PistolAttributes : IBlockScoped, BaseGunAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = PistolAttributes.buffItems
	
	override val cloak: CloakAttributes get() = PistolAttributes.cloak
	...
	override val hud: HudAttributes get() = PistolAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = PistolAttributes.spyOnly
	...
	object Inherited : PistolAttributes 
}