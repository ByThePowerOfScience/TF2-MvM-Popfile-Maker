...
interface SlapAttributes : IBlockScoped, BaseMeleeAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = SlapAttributes.buffItems
	
	override val cloak: CloakAttributes get() = SlapAttributes.cloak
	...
	override val hud: HudAttributes get() = SlapAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = SlapAttributes.spyOnly
	...
	object Inherited : SlapAttributes 
}