...
interface BuilderAttributes : IBlockScoped, WeaponBaseAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = BuilderAttributes.buffItems
	
	override val cloak: CloakAttributes get() = BuilderAttributes.cloak
	
	override val disguise: DisguiseAttributes get() = BuilderAttributes.disguise
	
	override val hud: HudAttributes get() = BuilderAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = BuilderAttributes.spyOnly
	...
	object Inherited : BuilderAttributes 
}