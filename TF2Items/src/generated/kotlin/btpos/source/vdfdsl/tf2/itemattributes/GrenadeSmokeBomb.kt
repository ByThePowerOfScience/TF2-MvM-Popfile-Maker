...
interface GrenadeSmokeBombAttributes : IBlockScoped, WeaponBaseGrenadeAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = GrenadeSmokeBombAttributes.buffItems
	
	override val cloak: CloakAttributes get() = GrenadeSmokeBombAttributes.cloak
	...
	override val hud: HudAttributes get() = GrenadeSmokeBombAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = GrenadeSmokeBombAttributes.spyOnly
	...
	object Inherited : GrenadeSmokeBombAttributes 
}