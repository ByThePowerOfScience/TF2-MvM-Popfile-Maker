...
interface LunchboxAttributes : IBlockScoped, WeaponBaseAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = LunchboxAttributes.buffItems
	
	override val cloak: CloakAttributes get() = LunchboxAttributes.cloak
	...
	override val hud: HudAttributes get() = LunchboxAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = LunchboxAttributes.spyOnly
	...
	object Inherited : LunchboxAttributes 
}