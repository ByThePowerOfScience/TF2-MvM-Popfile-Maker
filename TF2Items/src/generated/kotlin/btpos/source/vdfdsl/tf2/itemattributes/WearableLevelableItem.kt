...
interface WearableLevelableItemAttributes : IBlockScoped, WearableAttributes {
	 ...
	 * Attributes related to max ammo, clip-size, and resupply.
	 */
	override val ammo: AmmoAttributes get() = WearableLevelableItemAttributes.ammo
	
	override val buffItems: BuffItemsAttributes get() = WearableLevelableItemAttributes.buffItems
	
	/**
	 * Attributes related to moving, constructing, and interacting with the Engineer's buildings.
	 */
	override val buildings: BuildingsAttributes get() = WearableLevelableItemAttributes.buildings
	
	override val cloak: CloakAttributes get() = WearableLevelableItemAttributes.cloak
	 ...
	 * Some of these attributes are hardcoded to only work on the Demoman. These are noted in their documentation.
	 */
	override val demoCharge: DemoChargeAttributes get() = WearableLevelableItemAttributes.demoCharge
	 ...
	 * Attributes governing rate-of-fire.
	 */
	override val firing: FiringAttributes get() = WearableLevelableItemAttributes.firing
	 ...
	 * For "revenge crits", like the Frontier Justice, Manmelter, and Diamondback, see [revengeCrits].
	 */
	override val heads: HeadsAttributes get() = WearableLevelableItemAttributes.heads
	
	/**
	 * Attributes related to the player's HP stat and healing players.
	 */
	override val healthAndHealing: HealthAndHealingAttributes get() = WearableLevelableItemAttributes.healthAndHealing
	
	override val hud: HudAttributes get() = WearableLevelableItemAttributes.hud
	 ...
	 * Attributes governing the player's move-speed, jump height, swimming, air-strafing capabilities, and all things mobility-related.
	 */
	override val movement: MovementAttributes get() = WearableLevelableItemAttributes.movement
	 ...
	 * @see onKill
	 */
	override val onHit: OnHitAttributes get() = WearableLevelableItemAttributes.onHit
	 ...
	 * @see onHit
	 */
	override val onKill: OnKillAttributes get() = WearableLevelableItemAttributes.onKill
	
	/**
	 * Attributes governing taunt speed and the effects of taunts.
	 */
	override val taunting: TauntingAttributes get() = WearableLevelableItemAttributes.taunting
	
	/**
	 * Attributes governing weapon deploy/holster speed, things that activate when a weapon is deployed, and whether a player can swap weapons at all.
	 */
	override val swapWeapons: SwapWeaponsAttributes get() = WearableLevelableItemAttributes.swapWeapons
	 ...
	 * For what happens when _this player_ hits an enemy, see [onHit] and [onKill].
	 */
	override val whenHit: WhenHitAttributes get() = WearableLevelableItemAttributes.whenHit
	
	override val spyOnly: SpyOnlyAttributes get() = WearableLevelableItemAttributes.spyOnly
	...
	object Inherited : WearableLevelableItemAttributes 
}