...
interface JarAttributes : IBlockScoped, BaseGunAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = JarAttributes.buffItems
	
	override val cloak: CloakAttributes get() = JarAttributes.cloak
	...
	override val hud: HudAttributes get() = JarAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = JarAttributes.spyOnly
	...
	open class ProjectilesAttributes : BaseGunAttributes.ProjectilesAttributes() {
		 ...
		 */
		override val overrideType: ItemAttributeNamed<TFProjectileType> get() = super.overrideType
	...
	object Inherited : JarAttributes 
}