...
interface SyringeGunAttributes : IBlockScoped, BaseGunAttributes {
	...
	override val afterburn: AfterburnAttributes get() = SyringeGunAttributes.afterburn
	
	override val buildings: BuildingsAttributes get() = SyringeGunAttributes.buildings
	
	override val crits: CritsAttributes get() = SyringeGunAttributes.crits
	
	override val demoCharge: DemoChargeAttributes get() = SyringeGunAttributes.demoCharge
	
	override val healthAndHealing: HealthAndHealingAttributes get() = SyringeGunAttributes.healthAndHealing
	
	override val knockbackReceived: KnockbackReceivedAttributes get() = SyringeGunAttributes.knockbackReceived
	
	override val meta: MetaAttributes get() = SyringeGunAttributes.meta
	
	override val meter: MeterAttributes get() = SyringeGunAttributes.meter
	
	override val movement: MovementAttributes get() = SyringeGunAttributes.movement
	
	override val heads: HeadsAttributes get() = SyringeGunAttributes.heads
	
	override val onHit: OnHitAttributes get() = SyringeGunAttributes.onHit
	
	override val onKill: OnKillAttributes get() = SyringeGunAttributes.onKill
	
	override val reloading: ReloadingAttributes get() = SyringeGunAttributes.reloading
	
	override val resistance: ResistanceAttributes get() = SyringeGunAttributes.resistance
	
	override val revengeCrits: RevengeCritsAttributes get() = SyringeGunAttributes.revengeCrits
	
	override val statusEffects: StatusEffectsAttributes get() = SyringeGunAttributes.statusEffects
	
	override val taunting: TauntingAttributes get() = SyringeGunAttributes.taunting
	
	override val swapWeapons: SwapWeaponsAttributes get() = SyringeGunAttributes.swapWeapons
	
	override val whenHit: WhenHitAttributes get() = SyringeGunAttributes.whenHit
	
	override val ragdolls: RagdollsAttributes get() = SyringeGunAttributes.ragdolls
	
	override val buffItems: BuffItemsAttributes get() = SyringeGunAttributes.buffItems
	
	override val cloak: CloakAttributes get() = SyringeGunAttributes.cloak
	
	override val disguise: DisguiseAttributes get() = SyringeGunAttributes.disguise
	
	override val hud: HudAttributes get() = SyringeGunAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = SyringeGunAttributes.spyOnly
	...
	object Inherited : SyringeGunAttributes 
}