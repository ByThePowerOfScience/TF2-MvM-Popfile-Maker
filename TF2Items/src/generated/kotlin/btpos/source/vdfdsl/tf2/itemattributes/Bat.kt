...
interface BatAttributes : IBlockScoped, BaseMeleeAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = BatAttributes.buffItems
	
	override val cloak: CloakAttributes get() = BatAttributes.cloak
	...
	override val hud: HudAttributes get() = BatAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = BatAttributes.spyOnly
	...
	object Inherited : BatAttributes 
}