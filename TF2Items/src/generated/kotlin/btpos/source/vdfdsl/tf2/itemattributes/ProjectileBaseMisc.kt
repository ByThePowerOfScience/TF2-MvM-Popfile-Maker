...
interface ProjectileBaseMiscAttributes : IBlockScoped, BaseProjectileAttributes {
	 ...
	 * If true, applies mad milk to hit target for 4 seconds, with successive hits adding 0.5 seconds to the effect time per shot.
	 */
	val madMilkSyringes: ItemAttributeNamed<Boolean> get() = ProjectileBaseMiscAttributes.madMilkSyringes
	
	object Inherited : ProjectileBaseMiscAttributes 
}