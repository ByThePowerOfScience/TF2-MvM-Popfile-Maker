...
interface RocketLauncherAttributes : IBlockScoped, BaseGunAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = RocketLauncherAttributes.buffItems
	
	override val cloak: CloakAttributes get() = RocketLauncherAttributes.cloak
	...
	override val hud: HudAttributes get() = RocketLauncherAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = RocketLauncherAttributes.spyOnly
	...
	object Inherited : RocketLauncherAttributes 
}