...
interface FistsAttributes : IBlockScoped, BaseMeleeAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = FistsAttributes.buffItems
	
	override val cloak: CloakAttributes get() = FistsAttributes.cloak
	...
	override val hud: HudAttributes get() = FistsAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = FistsAttributes.spyOnly
	...
	object Inherited : FistsAttributes 
}