...
interface GrenadeMirvAttributes : IBlockScoped, WeaponBaseGrenadeAttributes {
	...
	override val afterburn: AfterburnAttributes get() = GrenadeMirvAttributes.afterburn
	
	override val ammo: AmmoAttributes get() = GrenadeMirvAttributes.ammo
	
	override val buildings: BuildingsAttributes get() = GrenadeMirvAttributes.buildings
	
	override val crits: CritsAttributes get() = GrenadeMirvAttributes.crits
	
	override val damage: DamageAttributes get() = GrenadeMirvAttributes.damage
	
	override val demoCharge: DemoChargeAttributes get() = GrenadeMirvAttributes.demoCharge
	
	override val firing: FiringAttributes get() = GrenadeMirvAttributes.firing
	
	override val healthAndHealing: HealthAndHealingAttributes get() = GrenadeMirvAttributes.healthAndHealing
	
	override val knockbackReceived: KnockbackReceivedAttributes get() = GrenadeMirvAttributes.knockbackReceived
	
	override val meta: MetaAttributes get() = GrenadeMirvAttributes.meta
	
	override val meter: MeterAttributes get() = GrenadeMirvAttributes.meter
	
	override val movement: MovementAttributes get() = GrenadeMirvAttributes.movement
	
	override val heads: HeadsAttributes get() = GrenadeMirvAttributes.heads
	
	override val onHit: OnHitAttributes get() = GrenadeMirvAttributes.onHit
	
	override val onKill: OnKillAttributes get() = GrenadeMirvAttributes.onKill
	
	override val projectiles: ProjectilesAttributes get() = GrenadeMirvAttributes.projectiles
	
	override val reloading: ReloadingAttributes get() = GrenadeMirvAttributes.reloading
	
	override val resistance: ResistanceAttributes get() = GrenadeMirvAttributes.resistance
	
	override val revengeCrits: RevengeCritsAttributes get() = GrenadeMirvAttributes.revengeCrits
	
	override val statusEffects: StatusEffectsAttributes get() = GrenadeMirvAttributes.statusEffects
	
	override val taunting: TauntingAttributes get() = GrenadeMirvAttributes.taunting
	
	override val swapWeapons: SwapWeaponsAttributes get() = GrenadeMirvAttributes.swapWeapons
	
	override val whenHit: WhenHitAttributes get() = GrenadeMirvAttributes.whenHit
	
	override val ragdolls: RagdollsAttributes get() = GrenadeMirvAttributes.ragdolls
	
	override val buffItems: BuffItemsAttributes get() = GrenadeMirvAttributes.buffItems
	
	override val cloak: CloakAttributes get() = GrenadeMirvAttributes.cloak
	
	override val disguise: DisguiseAttributes get() = GrenadeMirvAttributes.disguise
	
	override val hud: HudAttributes get() = GrenadeMirvAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = GrenadeMirvAttributes.spyOnly
	...
	object Inherited : GrenadeMirvAttributes 
}