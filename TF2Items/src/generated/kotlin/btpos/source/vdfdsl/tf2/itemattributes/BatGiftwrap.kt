...
interface BatGiftwrapAttributes : IBlockScoped, BatWoodAttributes {
	...
	open class OnHitAttributes : BatWoodAttributes.OnHitAttributes() {
		...
		open class AddOnhitAddhealthAttributes : BatWoodAttributes.OnHitAttributes.AddOnhitAddhealthAttributes() 
	
		open class GenerateRageOnDmgAttributes : BatWoodAttributes.OnHitAttributes.GenerateRageOnDmgAttributes(), ItemAttribute<Boolean> 
	...
	open class DemoChargeAttributes : BatWoodAttributes.DemoChargeAttributes() {
		...
		open class ChargeTurnControlAttributes : BatWoodAttributes.DemoChargeAttributes.ChargeTurnControlAttributes(), ItemAttribute<Number> 
	}
	...
	open class HealthAndHealingAttributes : BatWoodAttributes.HealthAndHealingAttributes() {
		...
		open class AddHealthRegenAttributes : BatWoodAttributes.HealthAndHealingAttributes.AddHealthRegenAttributes(), ItemAttribute<Int> 
	
		open class AddMaxhealthAttributes : BatWoodAttributes.HealthAndHealingAttributes.AddMaxhealthAttributes(), ItemAttribute<Int> 
	}
	...
	open class MeterAttributes : BatWoodAttributes.MeterAttributes() {
		...
		open class GenerateRageOnDmgAttributes : BatWoodAttributes.MeterAttributes.GenerateRageOnDmgAttributes(), ItemAttribute<Boolean> 
	}
	...
	open class MovementAttributes : BatWoodAttributes.MovementAttributes() {
		...
		open class MoveSpeedAttributes : BatWoodAttributes.MovementAttributes.MoveSpeedAttributes() {
			...
			open class MultPlayerAimingMovespeedAttributes : BatWoodAttributes.MovementAttributes.MoveSpeedAttributes.MultPlayerAimingMovespeedAttributes() 
	
			open class MultPlayerMovespeedAttributes : BatWoodAttributes.MovementAttributes.MoveSpeedAttributes.MultPlayerMovespeedAttributes(), ItemAttribute<Number> 
		}
	
		open class ModJumpHeightAttributes : BatWoodAttributes.MovementAttributes.ModJumpHeightAttributes(), ItemAttribute<Number> 
	}
	...
	open class ResistanceAttributes : BatWoodAttributes.ResistanceAttributes() {
		...
		open class MultDmgtakenFromCritAttributes : BatWoodAttributes.ResistanceAttributes.MultDmgtakenFromCritAttributes(), ItemAttribute<Number> 
	
		open class MultDmgtakenFromFireAttributes : BatWoodAttributes.ResistanceAttributes.MultDmgtakenFromFireAttributes(), ItemAttribute<Number> 
	
		open class MultDmgtakenFromBulletsAttributes : BatWoodAttributes.ResistanceAttributes.MultDmgtakenFromBulletsAttributes(), ItemAttribute<Number> 
