...
interface LaserPointerAttributes : IBlockScoped, BaseGunAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = LaserPointerAttributes.buffItems
	
	override val cloak: CloakAttributes get() = LaserPointerAttributes.cloak
	...
	override val hud: HudAttributes get() = LaserPointerAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = LaserPointerAttributes.spyOnly
	...
	object Inherited : LaserPointerAttributes 
}