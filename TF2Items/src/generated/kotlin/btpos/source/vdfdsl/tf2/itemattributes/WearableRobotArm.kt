...
interface WearableRobotArmAttributes : IBlockScoped, WearableAttributes {
	...
	override val resistance: ResistanceAttributes get() = WearableRobotArmAttributes.resistance
	
	override val meta: MetaAttributes get() = WearableRobotArmAttributes.meta
	
	override val ammo: AmmoAttributes get() = WearableRobotArmAttributes.ammo
	
	override val buffItems: BuffItemsAttributes get() = WearableRobotArmAttributes.buffItems
	
	override val buildings: BuildingsAttributes get() = WearableRobotArmAttributes.buildings
	
	override val cloak: CloakAttributes get() = WearableRobotArmAttributes.cloak
	
	override val damage: DamageAttributes get() = WearableRobotArmAttributes.damage
	
	override val demoCharge: DemoChargeAttributes get() = WearableRobotArmAttributes.demoCharge
	
	override val disguise: DisguiseAttributes get() = WearableRobotArmAttributes.disguise
	
	override val firing: FiringAttributes get() = WearableRobotArmAttributes.firing
	
	override val heads: HeadsAttributes get() = WearableRobotArmAttributes.heads
	
	override val healthAndHealing: HealthAndHealingAttributes get() = WearableRobotArmAttributes.healthAndHealing
	
	override val hud: HudAttributes get() = WearableRobotArmAttributes.hud
	
	override val knockbackReceived: KnockbackReceivedAttributes get() = WearableRobotArmAttributes.knockbackReceived
	
	override val meter: MeterAttributes get() = WearableRobotArmAttributes.meter
	
	override val movement: MovementAttributes get() = WearableRobotArmAttributes.movement
	
	override val onHit: OnHitAttributes get() = WearableRobotArmAttributes.onHit
	
	override val onKill: OnKillAttributes get() = WearableRobotArmAttributes.onKill
	
	override val taunting: TauntingAttributes get() = WearableRobotArmAttributes.taunting
	
	override val swapWeapons: SwapWeaponsAttributes get() = WearableRobotArmAttributes.swapWeapons
	
	override val whenHit: WhenHitAttributes get() = WearableRobotArmAttributes.whenHit
	
	override val spyOnly: SpyOnlyAttributes get() = WearableRobotArmAttributes.spyOnly
	
	override val crits: CritsAttributes get() = WearableRobotArmAttributes.crits
	...
	object Inherited : WearableRobotArmAttributes 
}