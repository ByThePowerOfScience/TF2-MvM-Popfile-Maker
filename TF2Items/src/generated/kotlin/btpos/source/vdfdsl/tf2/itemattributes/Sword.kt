...
interface SwordAttributes : IBlockScoped, BaseMeleeAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = SwordAttributes.buffItems
	
	override val cloak: CloakAttributes get() = SwordAttributes.cloak
	...
	override val hud: HudAttributes get() = SwordAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = SwordAttributes.spyOnly
	...
	open class OnKillAttributes : BaseMeleeAttributes.OnKillAttributes() {
		 ...
		 */
		override val decapitateType: ItemAttributeNamed<Int> get() = super.decapitateType
	}
	...
	object Inherited : SwordAttributes 
}