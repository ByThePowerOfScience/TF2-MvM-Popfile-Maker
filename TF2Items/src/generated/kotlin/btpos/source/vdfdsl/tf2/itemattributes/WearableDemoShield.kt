...
interface WearableDemoShieldAttributes : IBlockScoped, WearableAttributes {
	...
	open class DemoChargeAttributes : WearableAttributes.DemoChargeAttributes() {
		 ...
		 */
		override val modChargeTime: VisHidden<Number> get() = super.modChargeTime
		 ...
		 */
		open val chargeImpactDamage: VisHidden<Number> = VisHidden(
		    ItemAttributeNamed("charge impact damage increased"),
		    ItemAttributeNamed("charge impact damage decreased")
		)
