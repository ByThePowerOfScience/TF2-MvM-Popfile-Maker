...
interface FireAxeAttributes : IBlockScoped, BaseMeleeAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = FireAxeAttributes.buffItems
	
	override val cloak: CloakAttributes get() = FireAxeAttributes.cloak
	...
	override val hud: HudAttributes get() = FireAxeAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = FireAxeAttributes.spyOnly
	...
	object Inherited : FireAxeAttributes 
}