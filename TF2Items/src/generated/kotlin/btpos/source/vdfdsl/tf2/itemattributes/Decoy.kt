...
interface DecoyAttributes : IBlockScoped, JarAttributes {
	...
	override val projectiles: ProjectilesAttributes get() = DecoyAttributes.projectiles
	
	override val meter: MeterAttributes get() = DecoyAttributes.meter
	
	override val onHit: OnHitAttributes get() = DecoyAttributes.onHit
	
	override val ammo: AmmoAttributes get() = DecoyAttributes.ammo
	
	override val damage: DamageAttributes get() = DecoyAttributes.damage
	
	override val firing: FiringAttributes get() = DecoyAttributes.firing
	
	override val afterburn: AfterburnAttributes get() = DecoyAttributes.afterburn
	
	override val buildings: BuildingsAttributes get() = DecoyAttributes.buildings
	
	override val crits: CritsAttributes get() = DecoyAttributes.crits
	
	override val demoCharge: DemoChargeAttributes get() = DecoyAttributes.demoCharge
	
	override val healthAndHealing: HealthAndHealingAttributes get() = DecoyAttributes.healthAndHealing
	
	override val knockbackReceived: KnockbackReceivedAttributes get() = DecoyAttributes.knockbackReceived
	
	override val meta: MetaAttributes get() = DecoyAttributes.meta
	
	override val movement: MovementAttributes get() = DecoyAttributes.movement
	
	override val heads: HeadsAttributes get() = DecoyAttributes.heads
	
	override val onKill: OnKillAttributes get() = DecoyAttributes.onKill
	
	override val reloading: ReloadingAttributes get() = DecoyAttributes.reloading
	
	override val resistance: ResistanceAttributes get() = DecoyAttributes.resistance
	
	override val revengeCrits: RevengeCritsAttributes get() = DecoyAttributes.revengeCrits
	
	override val statusEffects: StatusEffectsAttributes get() = DecoyAttributes.statusEffects
	
	override val taunting: TauntingAttributes get() = DecoyAttributes.taunting
	
	override val swapWeapons: SwapWeaponsAttributes get() = DecoyAttributes.swapWeapons
	
	override val whenHit: WhenHitAttributes get() = DecoyAttributes.whenHit
	
	override val ragdolls: RagdollsAttributes get() = DecoyAttributes.ragdolls
	
	override val buffItems: BuffItemsAttributes get() = DecoyAttributes.buffItems
	
	override val cloak: CloakAttributes get() = DecoyAttributes.cloak
	
	override val disguise: DisguiseAttributes get() = DecoyAttributes.disguise
	
	override val hud: HudAttributes get() = DecoyAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = DecoyAttributes.spyOnly
	...
	object Inherited : DecoyAttributes 
}