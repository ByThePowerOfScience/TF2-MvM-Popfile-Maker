...
interface GrapplingHookAttributes : IBlockScoped, RocketLauncherAttributes {
	...
	override val buffItems: BuffItemsAttributes get() = GrapplingHookAttributes.buffItems
	
	override val cloak: CloakAttributes get() = GrapplingHookAttributes.cloak
	...
	override val hud: HudAttributes get() = GrapplingHookAttributes.hud
	
	override val spyOnly: SpyOnlyAttributes get() = GrapplingHookAttributes.spyOnly
	...
	object Inherited : GrapplingHookAttributes 
}