...
interface ScoutPistolAttributes : IBlockScoped, PistolAttributes {
	...
	open class ProjectilesAttributes : PistolAttributes.ProjectilesAttributes() {
		...
		open class ProjectilePenetrationAttributes : PistolAttributes.ProjectilesAttributes.ProjectilePenetrationAttributes(), ItemAttribute<Int> 
	}
	...
	open class DemoChargeAttributes : PistolAttributes.DemoChargeAttributes() {
		...
		open class ChargeTurnControlAttributes : PistolAttributes.DemoChargeAttributes.ChargeTurnControlAttributes(), ItemAttribute<Number> 
	}
	...
	open class HealthAndHealingAttributes : PistolAttributes.HealthAndHealingAttributes() {
		...
		open class AddHealthRegenAttributes : PistolAttributes.HealthAndHealingAttributes.AddHealthRegenAttributes(), ItemAttribute<Int> 
	
		open class AddMaxhealthAttributes : PistolAttributes.HealthAndHealingAttributes.AddMaxhealthAttributes(), ItemAttribute<Int> 
	}
	...
	open class MeterAttributes : PistolAttributes.MeterAttributes() {
		...
		open class GenerateRageOnDmgAttributes : PistolAttributes.MeterAttributes.GenerateRageOnDmgAttributes(), ItemAttribute<Boolean> 
	}
	...
	open class MovementAttributes : PistolAttributes.MovementAttributes() {
		...
		open class MoveSpeedAttributes : PistolAttributes.MovementAttributes.MoveSpeedAttributes() {
			...
			open class MultPlayerAimingMovespeedAttributes : PistolAttributes.MovementAttributes.MoveSpeedAttributes.MultPlayerAimingMovespeedAttributes() 
	
			open class MultPlayerMovespeedAttributes : PistolAttributes.MovementAttributes.MoveSpeedAttributes.MultPlayerMovespeedAttributes(), ItemAttribute<Number> 
		}
	
		open class ModJumpHeightAttributes : PistolAttributes.MovementAttributes.ModJumpHeightAttributes(), ItemAttribute<Number> 
	}
	...
	open class OnHitAttributes : PistolAttributes.OnHitAttributes() {
		...
		open class AddOnhitAddhealthAttributes : PistolAttributes.OnHitAttributes.AddOnhitAddhealthAttributes() 
	
		open class GenerateRageOnDmgAttributes : PistolAttributes.OnHitAttributes.GenerateRageOnDmgAttributes(), ItemAttribute<Boolean> 
	...
	open class ResistanceAttributes : PistolAttributes.ResistanceAttributes() {
		...
		open class MultDmgtakenFromCritAttributes : PistolAttributes.ResistanceAttributes.MultDmgtakenFromCritAttributes(), ItemAttribute<Number> 
	
		open class MultDmgtakenFromFireAttributes : PistolAttributes.ResistanceAttributes.MultDmgtakenFromFireAttributes(), ItemAttribute<Number> 
	
		open class MultDmgtakenFromBulletsAttributes : PistolAttributes.ResistanceAttributes.MultDmgtakenFromBulletsAttributes(), ItemAttribute<Number> 
