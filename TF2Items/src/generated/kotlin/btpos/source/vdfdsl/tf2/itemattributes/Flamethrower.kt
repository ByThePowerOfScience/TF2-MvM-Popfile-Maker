...
interface FlamethrowerAttributes : IBlockScoped, BaseGunAttributes {
	...
	open class AirblastAttributes : IBlockScoped {
		 ...
		 * Hidden:
		 */
		open val multAirblastCost: BonusPenaltyHidden<Number, ItemAttributeNamed<Number>> = BonusPenaltyHidden(
	...
	open class AmmoAttributes : BaseGunAttributes.AmmoAttributes() {
		 ...
		 * 	- In-Game: "+N% flamethrower ammo consumed per second"
		 */
		open val multFlameAmmopersec: BonusPenalty<Number> = BonusPenalty(
	...
	open class FlamesAttributes : IBlockScoped {
		 ...
		 */
		open val multFlameSize: BonusPenalty<Number> = BonusPenalty(
		 ...
		 */
		open val multFlameLife: BonusPenalty<Number> = BonusPenalty(
