...
interface IMvMSubtree {
	...
	companion object {
		 ...
		 * ```
		 *
		 * @param serializationKey Either a regular string if it should be unquoted in the popfile (e.g. `Objective` instead of `"Objective"`) or a [PopFileLiteralString][btpos.tf2.popfiledsl.serialization.VDFStringLiteral] if the key should be quoted in the popfile (e.g. `"mark for death"` instead of `mark for death`)
		 */
		 ...
		 * use [addField] with a [PopFileMap][btpos.tf2.popfiledsl.serialization.VDFSubtree]
