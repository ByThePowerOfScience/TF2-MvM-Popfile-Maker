 ...
 */
abstract class AbstractVDFStruct(protected val _subtree: ExtensibleSubtreeImpl = ExtensibleSubtreeImpl()) : IVDFRepresentableKeyValue, IExtensibleSubtree by _subtree {
